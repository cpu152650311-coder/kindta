...
const STATS = [
  { value: 999, suffix: '+', label: 'Global Clients', desc: 'Serving customers across 30+ countries' },
  { value: 15, suffix: '+', label: 'Years Experience', desc: 'Deep domain expertise in sensor engineering' },
...
const TIMELINE = [
  { year: 'Founded', title: 'Company Established', desc: 'Shenzhen Kingdta Technology Co., Ltd. was founded with a vision to become a key enabler in the intelligent hardware ecosystem.' },
