...
// Three main category cards using B2 images
const CATEGORIES = [
  {
    img: '/B2.1.png',
    tag: 'Most Popular',
    ...
    desc: 'High sensitivity, long lifespan (>2M cycles), high-temp polymer material, compact size.',
    applications: 'Vibration sensing systems, smart anti-theft devices, TPMS, wearables wake-up.',
    href: '#kd1902s',
  ...
  },
  {
    ...
    title: 'Tilt & Angle\nSensors',
    desc: '360° omnidirectional tilt triggering, stable performance, micro-amp power consumption, high accuracy.',
  ...
  },
  {
    ...
    desc: 'Based on proven vibration/tilt technology, offering oriented design, R&D, and manufacturing for your specific needs.',
...
const PRODUCTS = [
  {
    ...
    specs: [
      ...
      { key: 'Trigger Direction', val: '360° Omni' },
      { key: 'Response Time', val: '< 5ms' },
      { key: 'Life Cycles', val: '> 2,000,000' },
      { key: 'Package', val: 'SMD 3.5×2.5mm' },
      { key: 'Operating Temp', val: '-40°C to +85°C' },
      { key: 'Compliance', val: 'RoHS' },
      { key: 'Sensitivity', val: 'Adjustable' },
    ],
    features: ['360° Omnidirectional', 'High Polymer Body', 'SMD Package', 'RoHS', '2M+ Life Cycles', 'Custom Sensitivity'],
    applications: ['GPS Asset Trackers', 'TPMS Systems', 'Smart Anti-theft', 'IoT Wake-up', 'Wearables'],
  },
  {
    id: 'kd1908s',
    model: 'KD1908S',
    ...
    specs: [
      ...
      { key: 'Trigger Angle', val: '10° —?45° (adjustable)' },
      { key: 'Standby Current', val: '< 1μA' },
      { key: 'Life Cycles', val: '> 100,000' },
      { key: 'Package', val: 'SMD 3.5×2.5mm' },
      { key: 'Operating Temp', val: '-20°C to +70°C' },
      { key: 'Compliance', val: 'RoHS' },
  ...
  },
  {
    ...
    intro: 'Industry-leading optical tilt detection covering the full 360° sphere. Non-contact optical design ensures superior accuracy and eliminates mechanical wear —?ideal for safety shutoffs and anti-tamper devices.',
    specs: [
      { key: 'Operating Voltage', val: '3.3V —?5V' },
      { key: 'Detection Range', val: '360° Full Sphere' },
      { key: 'Response Time', val: '< 10ms' },
      { key: 'Life Cycles', val: 'Optical —?No Wear' },
      { key: 'Package', val: 'SMD 5.0×3.8mm' },
      { key: 'Operating Temp', val: '-40°C to +85°C' },
      { key: 'Compliance', val: 'RoHS' },
      { key: 'Principle', val: 'Optical (Non-contact)' },
    ],
    features: ['Optical Design', '360° Coverage', 'SMD Package', 'RoHS', 'No Mechanical Wear', 'High Reliability'],
  ...
  },
  {
    ...
    specs: [
      ...
      { key: 'Package', val: 'SMD 4.0×3.0mm' },
      { key: 'Operating Temp', val: '-40°C to +105°C' },
      { key: 'Compliance', val: 'RoHS' },
  ...
  },
  {
    ...
    intro: 'Designed specifically for battery-powered IoT devices where every microamp matters. The KD1901S achieves nano-ampere standby current while maintaining responsive motion detection.',
    specs: [
      { key: 'Operating Voltage', val: '1.8V —?3.6V' },
      { key: 'Trigger Direction', val: '360° Omni' },
      { key: 'Standby Current', val: '< 100nA' },
      { key: 'Life Cycles', val: '> 1,000,000' },
      { key: 'Package', val: 'SMD 2.0×1.6mm' },
      { key: 'Operating Temp', val: '-40°C to +85°C' },
      { key: 'Compliance', val: 'RoHS' },
            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-1/2 -translate-x-1/2 pt-0 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                <div className="bg-white rounded-2xl shadow-2xl border border-gray-100 overflow-hidden w-60 mt-1">
                  <div className="p-2">
                    <a href="/products" className="flex items-center gap-3 px-3 py-2.5 rounded-xl bg-green-50 transition-colors">
                      ...
                      <div>
                        <p className="text-green-700 font-semibold text-xs">All Products</p>
                  ...
                  <div className="border-t border-gray-50 px-2 pb-2 pt-1">
                    ...
                    {PRODUCT_NAV.map((p, i) => (
                      <button key={p.model} onClick={() => { setActiveProduct(i); document.getElementById('detail')?.scrollIntoView({ behavior: 'smooth' }) }}
                        className={`w-full flex items-center justify-between px-3 py-2 rounded-xl hover:bg-gray-50 transition-colors group/item ${activeProduct === i ? 'bg-green-50' : ''}`}>
                        <span className={`font-semibold text-sm group-hover/item:text-green-700 transition-colors ${activeProduct === i ? 'text-green-700' : 'text-gray-800'}`}>{p.model}</span>
        ...
        {menuOpen && (
          <div className="md:hidden border-t border-gray-100 bg-white px-6 py-4 space-y-1">
            ...
            <div className="pl-4 space-y-1 pb-1">
              {PRODUCT_NAV.map((p, i) => (
                <button key={p.model} onClick={() => { setActiveProduct(i); setMenuOpen(false); document.getElementById('detail')?.scrollIntoView({ behavior: 'smooth' }) }}
                  className="w-full flex items-center justify-between text-gray-500 text-sm py-1.5">
          ...
          <div ref={heroRef.ref} className="relative max-w-7xl mx-auto px-6 lg:px-8">
            ...
            <div className="max-w-3xl">
              ...
              <p className={`text-gray-500 text-lg leading-relaxed max-w-2xl ${heroRef.inView ? 'anim-fade-up delay-200' : 'opacity-0'}`}>
                From ultra-low-power vibration wake-up sensors to 360° optical tilt detection —?every component engineered for reliability, compact form factor, and seamless integration into your hardware design.
              </p>
            </div>
          </div>
        </section>

        {/* ── CATEGORY CARDS (B2 images) ── */}
              ...
              <div className="grid grid-cols-1 lg:grid-cols-5">
                ...
                <div className="lg:col-span-3 p-7 lg:p-9">
                  ...
                  <div className="flex flex-wrap gap-3">
                    ...
                    <a href={`/blog/${prod.id}`} className="inline-flex items-center gap-2 border border-gray-200 hover:border-green-300 text-gray-700 hover:text-green-700 font-semibold px-5 py-2.5 rounded-xl transition-colors text-sm bg-white">
