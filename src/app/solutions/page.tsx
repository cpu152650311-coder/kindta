...
const INDUSTRIES = [
  {
    ...
    desc: 'Our ultra-low-power vibration and tilt sensors are ideal motion wake-up triggers for battery-powered security devices, minimizing power draw while ensuring an immediate response to movement.',
    applications: [
...
const TESTIMONIALS = [
  {
    quote: "Kingdta's vibration sensor solution was a game-changer for our smart security devices. Their precise sensitivity adjustment eliminated our false alarm issue.",
    name: 'G.H.',
