          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-gray-400 text-sm leading-relaxed mb-10">
                From nano-amp IoT wake-up to 5M-cycle industrial durability — one partner from sensor design to finished board.
              </p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
            ...
            <div>
              ...
              <p className="text-gray-500 leading-relaxed mb-5">
                Headquartered in Shenzhen's Bao'an District, Kingdta Electronics specializes in passive, ultra-low-power vibration and tilt sensor design and application engineering — solving your most demanding sensing challenges from prototype through mass production.
              </p>
              <p className="text-gray-500 leading-relaxed mb-7">
                Our core advantage is co-designing the sensor and PCBA as one unified system, optimizing for performance, cost, and manufacturability from the very first design review. One partner. One bill. Zero integration risk.
              </p>
      ...
      <section className="py-20 bg-gray-50 border-t border-gray-100">
        <div className="max-w-6xl mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { quote: "Jindetai's vibration sensor solution was a game-changer for our smart security devices. Their precise sensitivity adjustment completely solved our false alarm issue.", name: 'G.H', title: 'Senior Product Manager' },
              { quote: "Jindetai's ultra-low power wake-up sensors helped us extend our device's standby time by 40%. Their hardware solution is exactly what we needed for long-term reliability.", name: 'L.D', title: 'Lead Hardware Engineer' },
