...
const STATS = [
  { value: 999, suffix: '+', label: 'Global Clients' },
...
const PRODUCTS = [
  {
    ...
    color: '#16a34a',
    applications: ['Smart Anti-theft', 'TPMS Wake-up', 'Wearables', 'Asset Trackers'],
  },
  {
    model: 'KD1908S',
    name: 'Angle Sensor',
    ...
    specs: ['360° Range', '±1° Accuracy', 'SMD Package', 'Low Power'],
  ...
  },
  {
    ...
    specs: ['Optical Design', 'SMD Package', '360° Coverage', 'RoHS'],
    desc: 'Industry-leading optical tilt detection covering the full 360° sphere —?ideal for safety shutoffs and anti-tamper devices.',
    color: '#0d9488',
...
const TESTIMONIALS = [
  {
    quote: "Jindetai's vibration sensor solution was a game-changer for our smart security devices. Their precise sensitivity adjustment completely solved our false alarm issue. It is rare to find a partner who understands 'Sense & Wake-up' logic so well.",
    name: 'G.H.',
      ...
      <main className="pt-16">
          ...
          <div ref={heroRef.ref} className="relative max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className={heroRef.inView ? 'anim-fade-up' : 'opacity-0'}>
              ...
              <p className="text-gray-500 text-lg leading-relaxed mb-8 max-w-lg">
                Shenzhen Kingdta Technology —?specialists in passive sensor design, application engineering, and integrated hardware solutions. ISO 9001 certified, serving 999+ clients across 30+ countries.
              </p>
        ...
        <section className="py-16 bg-gray-50 border-y border-gray-100">
          <div className="max-w-7xl mx-auto px-6 lg:px-8">
            <p className="text-center text-sm font-semibold text-gray-400 uppercase tracking-widest mb-10">合作伙伴 &amp; 客户</p>
