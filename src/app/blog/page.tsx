...
const POSTS = [
  ...
  },
  {
    ...
    excerpt: 'Learn how the WT4104B-C01 radar module brings BSD, lane-change assistance, and rear warning capability to e-bikes, scooters, and compact vehicles.',
    date: 'Mar 17, 2026',
    readTime: '7 min read',
    category: 'Application Guide',
  ...
  },
  {
    ...
    excerpt: 'In deployed IoT devices, the sensor is often the mechanical weak point. The KD1902S uses a vacuum-sealed core-shell structure to deliver 2M+ cycles of reliable vibration sensing.',
    date: 'Dec 15, 2025',
    readTime: '7 min read',
    category: 'Product Deep Dive',
  ...
  },
  {
    ...
    excerpt: 'Standard market alternatives fail around 100k-200k cycles. The KD1912 achieves 5 million reliable triggers using advanced materials and a vacuum-sealed core-shell structure.',
    date: 'Nov 28, 2025',
    readTime: '8 min read',
    category: 'Product Deep Dive',
...
export default function BlogListPage() {
  ...
  const categories = ['All', 'Application Guide', 'Product Deep Dive', 'Case Study']
