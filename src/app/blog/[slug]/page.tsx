...
const BLOG_POSTS: Record<string, {
  ...
  'kd1902s': {
    ...
    pdfLink: '/downloads/kd1902s-datasheet.pdf',
    sections: [
  ...
  'kd1912': {
    ...
    pdfLink: '/downloads/kd1912s-datasheet.pdf',
    sections: [
